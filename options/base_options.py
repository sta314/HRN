...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--name', type=str, default='hrn_v1.1', help='name of the experiment. It decides where to store samples and models')
        ...
        parser.add_argument('--base_ckpt_path', type=str, default='', help='models are saved here')
        ...
        parser.add_argument('--use_ddp', type=util_.str2bool, nargs='?', const=True, default=True, help='whether use distributed data parallel')
        parser.add_argument('--ddp_port', type=str, default='12355', help='ddp port')
        parser.add_argument('--display_per_batch', type=util_.str2bool, nargs='?', const=True, default=True, help='whether use batch to show losses')
        parser.add_argument('--add_image', type=util_.str2bool, nargs='?', const=True, default=True, help='whether add image to tensorboard')
    ...
    def gather_options(self, params):
        ...
        if opt.dataset_mode:
            ...
            dataset_option_setter = models.get_option_setter(dataset_name)
    ...
    def parse(self, params, verbose=False):
